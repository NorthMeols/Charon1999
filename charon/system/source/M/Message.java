...
public class Message implements Serializable
{
  ...
  private static final String MAGIC_TEXT  = "cHaRoN";  // Check compatability
...
//  Debug.trace( 0, "Message( message ) ict %d\n", act.longValue() );
  }
  ...
  public void makeReturnMessage()
  {
    ...
    message.put( MESSAGE_ICT, act );
//  Debug.trace( 0, "Message:makeReturnMessage ict/act %d\n", act.longValue() );
  }

  public boolean messageOK()
  {
    String checkMessage = get( MAGIC_KEY );
//  Debug.trace( 0, "MAGIC: [%s] [%s]", MAGIC_TEXT, checkMessage );
...
//  Debug.trace(0, "responceTime: ict %d act %d now %d %d\n", created, act.longValue(), now, now-created );
    return now - created;
  }
  ...
  public void put( String key, String data )
  {
    if ( key.equals( MAP ) )
    {
      ...
      seed = seed & 0xFFFF;
//    Debug.trace( 0, "Seed = %04X", seed );
//    Debug.trace( 0, "put key = %s", key );
...
//      Debug.trace( 0, "key = %s [No data associated]", key );
        return "";
